	...
	load: function(filename, callback){
		...
		LoadFile.loadImage(filename, function(img){
			...
			for(var i=0; i*4<idata.length; i++){
				...
				datastr += self.data[i].toString(16)+" ";//"["+idata[i*4]+","+idata[i*4+1]+","+idata[i*4+2]+"]";
			}
			datastr += "<br /><br /><br /><br /><br />";
			document.getElementById("testoutputfield").innerHTML += datastr;
