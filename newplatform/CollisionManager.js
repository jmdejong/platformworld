...
var CollisionManager = Class.extend({
	...
	resize: function(width,height){
		/* resize the area of the field covered by the CollisionManager */
		if (width>this.width){
		...
		this.width=width;
		this.height=height;
		this.getAll().forEach(function(obj){
			this.set(obj);
		}, this);
	},
	set: function(obj){
	...
	remove: function(obj){//console.log(obj,this.get(0, 0, this.width, this.height));
